...
class Config:
    ...
    # MAIL_SENDGRID_API_KEY: "APIKeyforSendGrid"
    # MAIL_DEFAULT_SENDER: "defaultsender"
...
class TestConfig(Config):
    ...
    Args:
        Config: The parent configuration class with General configuration settings
    '''
    SQLALCHEMY_DATABASE_URI = 'postgresql+psycopg2://postgres:o7oKanyi@localhost/weather-backend'
